...
class UpdateEmployeeComponent extends Component {
    ...
    validate = () => {
        ...
        if (emailIdError || firstNameError || lastNameError || passwordError || phoneNumberError || deptNoError){
            this.setState({firstNameError,lastNameError, emailIdError, passwordError,phoneNumberError,deptNoError});
    ...
    updateEmployee = (e) => {
        ...
        grab(`/api/v1/employees/${this.state.empId}`,"PUT", this.jwt, employee).then(res =>{
                        ...
                        <div className='card-body'>
                            ...
                            <div className='form-group'>
                                <label> Department:</label>  
                                    <select className='form-select' type='text' value={this.state.department && this.state.department.deptNo} onChange={this.changeDeptNoHandler}>
